        ...
        <div class="img-video-box">
            ...
            <div class="video-box">
                ...
                <div class="video-div" @click="dialogVisible_video">
                    ...
                    <div style="color:#AAA;font-size: 16px;font-weight: 600;line-height: 36px;">查看</div>
                </div>
    ...
    methods: {
        ...
        getParkAbilityPreview() {
            getParkAbilityPreview({ parkid: this.parkId }).then(res => {
                this.faceCaptureCountnew = res.data.faceCaptureCount//出入人员数
                this.carCaptureCountnew = res.data.carCaptureCount//出入车辆数
                this.statiList.forEach(item => {
...
.img-video-box {
    ...
    .video-box {
        ...
        .video-div {
            ...
            display: flex;
            justify-content: space-around;
            background: url("../../assets/img/pic/pxsp.jpg") no-repeat 100% 100%;
    ...
    .ganzhi-box {
        background: url("../../assets/img/pic/qygz.jpg") no-repeat 100% 100%;
        background-size: 100% 100%;
        height: 180px;
        border-radius: 14px;
        padding: 20px 40px;
